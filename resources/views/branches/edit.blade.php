...
@section('content')
    <div class="px-5 mt-5">
        <form action="{{url("/admin/branches/update",["id"=>$cat->id])}}" method="post">
            @csrf
            <div class="row">
                <div class="col col-6 form-group">
                    <label>Country</label>
                    <input type="text" class="form-control" value="{{$cat->country}}" placeholder="Enter Country..." name="country" required readonly />
                </div>
                <div class="col col-6 form-group">
                    <label>City</label>
